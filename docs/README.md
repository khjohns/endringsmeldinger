...
| [design: tilgangsmekanisme (B-02)](design-b02-tilgangsmekanisme-2026-09-22.md) · [oppdrag](prompt-b02-tilgangsmekanisme-2026-09-22.md) · [prototype](vedlegg/b02-prototype-2026-09-22/kjor.sh) | Grunnlag for B-02, ikke en beslutning. Tre alternativer mot trusselmodellen og F1. Anbefaler RLS for lesing, kommandoer for bindende skriving og skrivevakt på journalen. Prototype mot PostgreSQL 17 og PostgREST: 71 av 71 sjekker. TM-01: et selvsignert token kan velge `service_role` |
