...
- **Fullmaktsgrunnlag** (foreløpig regel, bør bekreftes): det største av tillegg og fradrag – aldri netto – pluss fristforlengelse × dagmulktssats. Uavklart pris eller frist, eller manglende sats når dager er angitt, gir uberegnet grunnlag, og da må hele kjeden godkjenne. Over alle fullmakter avvises. Et uberegnet grunnlag gjør aldri ruten svakere: det avtalte beløpet (største av tillegg og fradrag) er et gulv som noen i kjeden må dekke, ellers avvises ordren på samme måte som et beregnet beløp over alle fullmakter.
