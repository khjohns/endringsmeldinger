...
def test_varselinfo_structure():
    ...
    varsel = VarselInfo(dato_sendt="2025-01-15", metode=["epost", "byggemote"])
...
def test_varselinfo_single_method():
    ...
    varsel = VarselInfo(dato_sendt="2025-01-10", metode=["telefon"])
...
def test_grunnlag_event_creation():
    ...
    assert event.aktor_id == "Ole Olsen"
...
def test_vederlag_data_rigg_drift_varsel():
    ...
    data = VederlagData(
        ...
        saerskilt_krav=SaerskiltKrav(
            rigg_drift=SaerskiltKravItem(belop=15000, dato_klar_over="2025-01-12")
        ),
        rigg_drift_varsel=VarselInfo(
            dato_sendt="2025-01-12", metode=["byggemote", "epost"]
        ),
    )
...
def test_vederlag_data_produktivitetstap_varsel():
    ...
    data = VederlagData(
        ...
        saerskilt_krav=SaerskiltKrav(
            produktivitet=SaerskiltKravItem(belop=30000, dato_klar_over="2025-01-15")
        ),
        produktivitetstap_varsel=VarselInfo(dato_sendt="2025-01-15", metode=["epost"]),
    )
...
def test_vederlag_data_justert_ep_varsel():
    ...
    data = VederlagData(
        ...
        justert_ep_varsel=VarselInfo(dato_sendt="2025-01-13", metode=["epost", "brev"]),
    )
...
def test_frist_data_spesifisert():
    ...
    data = FristData(
        ...
        spesifisert_varsel=VarselInfo(
            dato_sendt="2025-01-20", metode=["epost", "brev"]
        ),
        antall_dager=14,
...
def test_event_with_varsel_serialization():
    ...
    event = VederlagEvent(
        ...
        data=VederlagData(
            ...
            begrunnelse="Test",
            rigg_drift_varsel=VarselInfo(
                dato_sendt="2025-01-15", metode=["epost", "byggemote"]
            ),
        ),
    )
...
class TestVederlagKompensasjon:
    ...
    def test_enhetspriser_netto_belop(self):
        ...
        komp = VederlagKompensasjon(
            metode=VederlagsMetode.ENHETSPRISER, belop_direkte=100000.0
        )
    ...
    def test_fastpris_netto_belop(self):
        ...
        komp = VederlagKompensasjon(
            metode=VederlagsMetode.FASTPRIS_TILBUD, belop_direkte=75000.0
        )
    ...
    def test_regningsarbeid_netto_belop(self):
        ...
        komp = VederlagKompensasjon(
            metode=VederlagsMetode.REGNINGSARBEID, kostnads_overslag=150000.0
        )
...
class TestEOUtstedtData:
    ...
    def test_eo_utstedt_vederlag_takes_precedence(self):
        ...
        eo = EOUtstedtData(
            ...
            vederlag=VederlagKompensasjon(
                metode=VederlagsMetode.FASTPRIS_TILBUD, belop_direkte=500000.0
            ),
    ...
    def test_eo_utstedt_har_fristkonsekvens(self):
        ...
        eo_with_frist_dager = EOUtstedtData(
            eo_nummer="EO-002", beskrivelse="Med frist_dager", frist_dager=14
        )
    ...
    def test_eo_utstedt_no_vederlag_no_legacy(self):
        ...
        eo = EOUtstedtData(eo_nummer="EO-2025-005", beskrivelse="No compensation")
