...
class LetterPdfGenerator:
    ...
    def generate_letter_pdf(
        self, brev_innhold: BrevInnhold, output_path: str | None = None
    ) -> bytes:
        """
    ...
    def _build_header(self, brev_innhold: BrevInnhold) -> list:
        ...
        header_table = Table(
            header_data, colWidths=[page_width * 0.5, page_width * 0.5]
        )
...
# Singleton instance
_generator: LetterPdfGenerator | None = None
