...
def backfill_reporting_cache(dry_run: bool = False) -> None:
    ...
    # Journalen leses bare under et autorisert prosjekt. Skriptet har ingen
    # forespørsel, så hver sak leses under prosjektet metadataene oppgir.
    kontekst = Flask(__name__)
    ...
    for case in all_cases:
        sak_id = case.sak_id
        try:
            with kontekst.app_context():
                g.project_id = case.prosjekt_id
