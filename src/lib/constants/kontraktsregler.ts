...
export const KONTRAKTSREGLER: Record<string, Kontraktsregel> = {
	...
	'33.1 c)': {
		regel: 'Andre forhold byggherren har risikoen for som ikke faller inn under endringer eller svikt, kan gi totalentreprenøren rett til fristforlengelse og vederlagsjustering.',
		konsekvens: 'Totalentreprenøren må varsle uten ugrunnet opphold. Byggherren må påberope sen varsling skriftlig uten ugrunnet opphold (§5).',
	},
