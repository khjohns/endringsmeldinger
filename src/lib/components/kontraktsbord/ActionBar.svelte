  ...
  <div class="action-inner">
    ...
    >
      ...
      {#if mode === 'form'}
        ...
        >
      {:else if role === 'TE'}
        {#if (sel !== 'frist' || hasFristSubmission) && (sel !== 'vederlag' || store.sak.vederlag.metode || store.sak.vederlag.varsler?.length)}
      ...
      {:else}
        <button
          ...
          disabled={sel === 'vederlag' && !store.sak.vederlag.metode}
          onclick={() => onform(sel)}
        >
          {sel === 'vederlag'
