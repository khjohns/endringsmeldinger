<script lang="ts">
  ...
  const submitLabel = $derived(scenario === 'edit' ? 'Oppdater krav §34' : 'Send krav §34');
...
<div class="te-vederlag-form">
  ...
  <FormSection>
    ...
    <p class="helptext">
      Eventuelle tilleggskrav for rigg/drift-kostnader eller produktivitetstap som følge av
      endringen.
    </p>
    <div class="field-amount">
      <NumberInput
