    ...
    <main class="midtpanel">
      <div class="midtpanel-scroll">
          ...
          <section class="bh-standpunkt">
            ...
            <div class="standpunkt-resultat resultat-{bhSvar.resultat}">
              <span class="resultat-badge"
                >{GRUNNLAG_RESULTAT_LABELS[bhSvar.resultat] ?? bhSvar.resultat}</span
              >
              {#if bhSvar.varsletITide !== undefined}
                <span
                  class="varsling-tag"
                  class:varsling-ok={bhSvar.varsletITide}
                  class:varsling-fail={!bhSvar.varsletITide}
                >
        ...
        <div class="form-footer">
          <Button variant="secondary" onclick={handleAvbryt}>Avbryt</Button>
          <Button
            variant="primary"
            disabled={!kanSende}
            loading={submitting}
